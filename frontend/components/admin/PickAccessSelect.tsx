...
import { PICK_ACCESS, PICK_ACCESS_LABELS, type PickAccess } from "@/types/picks";
            ...
            return (
              <li key={access} role="presentation">
                <button
                  ...
                  onClick={() => pick(access)}
                >
                  <span className="font-medium leading-none">{PICK_ACCESS_LABELS[access]}</span>
                  {isSelected ? (
